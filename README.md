...
## 📖 快速入门：如何配合 GitHub 公钥使用？

即便你是第一次使用甲骨文等 VPS，或者完全不了解 SSH 密钥，只需以下三步即可实现“无密码极速登录”：
...
### 第三步：运行本脚本一键换锁
在新服务器上运行本脚本，进入 **选项 2-3 (导入 GitHub 公钥)**，输入你的 GitHub 用户名。
- **效果**：脚本会自动从 GitHub 抓取你刚才上传的“锁”并安装到服务器上。
- **结果**：从此以后，你这台电脑登录这台服务器就像直接敲回车一样简单，且比密码登录安全千万倍。
