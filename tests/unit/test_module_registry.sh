...
assert_contains "$actual" $'security.login-hardening\tVerified SSH login hardening\t2.1.0-beta.1\tsecurity\tbuiltin' \
    "module registry discovers verified login hardening"
